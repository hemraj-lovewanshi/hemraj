...
import { CheckCircle2, Info, ExternalLink, Award } from 'lucide-react';
    ...
    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition duration-300 overflow-hidden flex flex-col h-full">
      <div className="p-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Why you fit</p>
              <p className="text-xs text-blue-700 italic leading-relaxed">{scheme.eligibilitySummary}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto p-6 pt-0">
        <a 
          ...
          className="flex items-center justify-center gap-2 w-full text-center py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition active:scale-95"
        >
